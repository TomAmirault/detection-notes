...
# Modèle YOLOv11 finetuné sur le dataset https://universe.roboflow.com/dty-opi9m/blank-sheet-segmentation-rvorv
model_path = os.path.join(BASE_DIR, '../detection_model/best-segment.pt')
...
try :
    for result in model.predict(source = 0, show = True, conf = 0.9, verbose = False, stream = True):
        boxes = result.boxes
